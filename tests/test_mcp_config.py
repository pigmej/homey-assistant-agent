...
class TestMCPConfigLoader:
    ...
    def test_create_http_server_valid(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "http", "url": "http://example.com/mcp"}
    ...
    def test_create_http_server_invalid_url_type(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "http", "url": 123}
    ...
    def test_create_stdio_server_valid(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "stdio", "command": "python", "args": ["-m", "server"]}

        with patch(
            "homey_assistant.config.mcp_config.mcp.MCPServerStdio"
        ) as mock_stdio:
    ...
    def test_create_stdio_server_missing_command(self):
        ...
        with pytest.raises(
            MCPConfigurationError, match="missing required 'command' field"
        ):
    ...
    def test_create_stdio_server_invalid_command_type(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "stdio", "command": 123}
    ...
    def test_create_stdio_server_invalid_args_type(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "stdio", "command": "python", "args": "not a list"}
    ...
    def test_create_stdio_server_invalid_arg_type(self):
        ...
        loader = MCPConfigLoader()
        server_config = {"type": "stdio", "command": "python", "args": ["-m", 123]}
    ...
    def test_create_server_invalid_type(self):
        ...
        with pytest.raises(
            MCPConfigurationError, match="unsupported type 'unsupported'"
        ):
    ...
    def test_create_server_missing_type(self):
        ...
        with pytest.raises(
            MCPConfigurationError, match="missing required 'type' field"
        ):
            loader._create_server("test_server", server_config)
    ...
    def test_create_server_non_dict_config(self):
        ...
        with pytest.raises(
            MCPConfigurationError, match="configuration must be an object"
        ):
    ...
    def test_load_servers_continues_on_server_error(self, temp_config_file):
        ...
        config = {
            "servers": {
                "valid_server": {"type": "http", "url": "http://example.com/mcp"},
                "invalid_server": {"type": "invalid_type"},
                "another_valid_server": {"type": "stdio", "command": "python"},
            }
        }
    ...
    def test_load_servers_io_error(self):
        ...
        with (
            ...
            with pytest.raises(
                MCPConfigurationError, match="Error reading MCP configuration file"
            ):
                loader.load_servers()
    ...
    def test_load_servers_with_environment_variable(self):
        ...
        with (
            patch.dict("os.environ", {"MCP_CONFIG_PATH": "custom_path.json"}),
            patch("os.path.exists", return_value=True),
